...
urlpatterns = [
    ...
    path('safety-inspection/create/', views.safety_inspection_create, name='safety_inspection_create'),
    ...
    path('medical_exam/delete/<int:pk>/', views.medical_exam_delete, name='medical_exam_delete'),
